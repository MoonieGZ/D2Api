...
namespace APIHelper.Structs
{
    public class Components
    {
        ...
        public enum QueryComponents
        {
            ...
            ///<summary>This will get you information about the silver that this profile has on every platform on which it plays.
            ///You may only request this component for the logged in user's Profile, and will not recieve it if you request it for another Profile.</summary>
            PlatformSilver = 105,
            ...
            ///<summary>Sometimes, designers create thousands of reusable plugs and suddenly your response sizes are almost 3MB, and something has to give.
            ...
            ///When you get this, you will also need to combine it with "Plug Sets" data if you want a full picture of all of the available plugs = this component will only return plugs that have state data that is per-item. See Plug Sets for available plugs that have Character, Profile, or no state-specific restrictions.</summary>
