...
namespace APIHelper.Structs
{
    public class Components
    {
        ...
        public enum QueryComponents
        {
            ...
            ///     you're allowed to see it. You have to either be authenticated as that user, or that user must allow anonymous
            ...
            ///     rendering library for Destiny Characters, or "borrowed" ours. It's okay, I won't tell anyone if you're using it.
            ...
            ///     authenticated user or the user has elected to allow anonymous viewing of its progression info. Note that the data
            ///     returned by this can be unfortunately problematic and relatively unreliable in some cases. We'll eventually work on
            ...
            /// <summary>
            ///     Items can have stats, like rate of fire. Asking for this component will return requested item's stats if they
            ///     have stats.
            /// </summary>
            ItemStats = 304,
            ...
            ///     component will return all relevant info about activated Nodes and Steps on this talent grid, like the good ol'
            ///     days.
            /// </summary>
            ItemTalentGrids = 306,
            ...
            ///     can/can't be inserted. I hear you giggling, there's nothing funny about inserting plugs. Get your head out of the
            ...
            ///     character can use to determine if an action (purchasing, socket insertion) has the required currency. (recall that
            ///     all currencies are just items, and that some vendor purchases require items that you might not traditionally
            ///     consider to be a "currency", like plugs/mods!)
            /// </summary>
            CurrencyLookups = 600,

            /// <summary>
            ///     Returns summary status information about all "Presentation Nodes". See DestinyPresentationNodeDefinition for
            ///     more details, but the gist is that these are entities used by the game UI to bucket Collectibles and Records into a
            ...
            ///     from a non-authoritative source such that we don't consider the data to be fully trustworthy, but that might prove
            ///     useful for some limited use cases. We can provide no guarantee of timeliness nor consistency for this data = buyer
        ...
        public enum State
        {
            ...
            ///<summary>If this flag is set, the collectible should not be shown to the user.</summary>
            Invisible = 4,
